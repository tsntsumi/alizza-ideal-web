...
exports.createSchemaCustomization = ({ actions }) => {
    ...
    const typeDefs = `
  type ContentsQuery implements Node {
    mdx: mdxNode
    allFile: allFileNode
  }
  type ContentsListQuery implements Node {
    allMdx: allMdxListNode 
  }
  type mdxNode implements Node {
    slug: String
    body: String
    fields: fieldsNode
    frontmatter: frontmatterNode
  }
  type fieldsNode implements Node {
    sourceName: String
    slug: String
  }
  type frontmatterNode implements Node {
    title: String
    date: Date
    description: String
    credit: String
  ...
  type childImageSharpNode implements Node {
    gatsbyImageData: Node
    id: String
  }
  type allFileNode implements Node {
    edges: [fileEdgeNode]
  }
  type fileEdgeNode implements Node {
    node: fileNode
  }
  ...
  type allMdxListNode implements Node {
    edges: [mdxEdgeListNode]
  }
  type mdxEdgeListNode implements Node {
    node: mdxListNode
  }
  type mdxListNode implements Node {
    id: String
    frontmatter: frontmatterNode
    fields: fieldsNode
  }
