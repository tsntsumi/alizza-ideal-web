...
date: 2021-07-28
thumbnail: ./whats-new-in-airtable-jul-2021.png
banner: ./banner.jpg
description: |
  <center>Webアプリケーションの画像などコンテンツの更新を簡単にしたいですか？</center>
  <center>Webフォームで登録してもらったメッセージを保存する場所に困ってませんか？</center>
  <p/>Airtableは、見た目も使い心地もシンプルなスプレッドシート風です。
